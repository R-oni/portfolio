...
window.initFlipbook = function(wrapperSelector) {
  ...
  const corMundo = "#98c2f7"; // Exemplo: azul claro
  ...
  if (!isMobile) {
    ...
    if (flipbookEl) {
      flipbookEl.style.background = '#98c2f7';
    }
  }
  ...
  slideEl.innerHTML = `
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%; background-color: ${corMundo};">
      ...
      <div style="width: 100%; display: flex; justify-content: center; margin-bottom: 20px;">
        <img src="mundos/Nyuoq-Vhess/nyuoq_dark.webp" style="max-width: 500px; width: 30%;" draggable="false">
      </div>
      ...
      <div class="area-preta-globo" style="width: 100%;
        ...
        <div class="globo-section" style="width: 100%; position: relative; display: flex; flex-direction: column; align-items: center;">
          ...
          <div class="globo-label" id="label-boramu" style="opacity: 0; background-color: rgba(0, 0, 0, 0.5); border-radius: 10px; padding: 10px; border: 1px solid #00ffe7; margin-top: 20px; text-align: center;">
            <div style="font-family: 'Press Start 2P', monospace; color: #00ffe7; font-size: 14px; padding: 10px; text-shadow: 0 0 10px rgba(0, 255, 231, 0.7); letter-spacing: 1px;">Nyuoq-Vhess</div>
      ...
      <div style="width: 100%; 
        ...
        <div style="width: 100%; max-width: 800px; margin-bottom: 60px;">
          <img src="mundos/Nyuoq-Vhess/imagens/personagens.webp" 
  ...
  setTimeout(() => {
    ...
    waitForSize('#globeCanvas', initGlobe, {
      ...
      planetTexture: 'mundos/cbdaf/mapacbdaf.webp',
      hasNuvem: true,
      nuvemTexture: 'mundos/cbdaf/nuvemcbdaf.webp',
...
function initOrbitalSystem() {
  ...
  function animate() {
    ...
    ctx.textAlign = 'center';
    ctx.fillStyle = '#fff';
    ctx.fillText('Ghoigoe', centerX, centerY + starSize * scale + 25);
    ...
    // Desenhar planetas
    drawPlanet(planet1X, planet1Y, planet1Size * scale, 'Grotoss');
    drawPlanet(planet2X, planet2Y, planet2Size * scale, 'Sai-Soss');
    drawPlanet(planet3X, planet3Y, planet3Size * scale, 'Nyuoq-Vhess');
